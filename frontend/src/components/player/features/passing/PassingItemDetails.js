 ...
 return (
   <div className='grid grid-cols-3 gap-4'>
     ...
     <div>
       ...
       <p className='text-sm font-bold'>{selectedItem.pass_outcome || 'Complete'}</p>
     </div>
     <div>
       <p className='text-xs text-gray-500'>Height</p>
       <p className='text-sm font-bold'>{selectedItem.pass_height || 'Ground'}</p>
     </div>
     <div>
       <p className='text-xs text-gray-500'>Progressive</p>
       <p className='text-sm font-bold'>{selectedItem.progressive ? 'Yes' : 'No'}</p>
     </div>
     <div>
       <p className='text-xs text-gray-500'>Assist</p>
       <p className='text-sm font-bold'>{selectedItem.assist ? 'Yes' : 'No'}</p>
     </div>
   </div>
 );
};