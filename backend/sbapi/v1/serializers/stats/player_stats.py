...
class PlayerMatchStatsSerializer(BaseMatchStatsSerializer, BasePlayerStatsSerializer):
    """Detailed stats for a player in a specific match"""
    # Basic info
    player_name = serializers.CharField()
    team_name = serializers.CharField()
    match_date = serializers.DateTimeField()  # Changed from DateField to DateTimeField to match match.start_datetime
...
class PlayerSeasonStatsSerializer(BaseSeasonStatsSerializer, BasePlayerStatsSerializer):
